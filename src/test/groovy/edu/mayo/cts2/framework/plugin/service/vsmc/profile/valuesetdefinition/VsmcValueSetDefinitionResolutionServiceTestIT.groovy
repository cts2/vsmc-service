...
class VsmcValueSetDefinitionResolutionServiceTestIT extends AbstractTestITBase {
    ...
    @Test
    void TestQueryAtEnd() {
        def id = new ValueSetDefinitionReadId("20140501", ModelUtils.nameOrUriFromName("2.16.840.1.113883.3.464.1003.113.12.1033"))
	...
	@Test
	void TestValidXml() {
		def id = new ValueSetDefinitionReadId("20140501", ModelUtils.nameOrUriFromName("2.16.840.1.113883.3.600.1.1498"))
